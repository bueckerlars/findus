...
User-facing product behavior is summarized in the [root README](../README.md). This section is the **technical wiki**: how Findus is built, how to run and extend it safely, and where things live in the codebase.
